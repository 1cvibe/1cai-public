...
class BusinessAnalystAgentEnhanced(BaseAgent):
    ...
    async def generate_acceptance_criteria(
        ...
        try:
            ...
            self.logger.error(f"Criteria generation failed: {e}")
            return []
    ...
    async def generate_bpmn(
        ...
        try:
            ...
            self.logger.error(f"BPMN generation failed: {e}")
            return {"status": "failed", "error": str(e)}
        ...
        try:
            ...
            if self.llm_selector:
                requirements = await self.llm_selector.generate(
                    ...
                    Формат: JSON
                    """,
                    context={"source": "meeting", "language": transcript.get("language", "ru")}
                )
            ...
            self.logger.error(f"Meeting transcription failed: {e}")
            return {"status": "failed", "error": str(e)}

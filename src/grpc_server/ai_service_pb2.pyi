...
class QueryRequest(_message.Message):
    ...
    user_id: str
    def __init__(self, query: _Optional[str] = ..., context: _Optional[str] = ..., metadata: _Optional[_Mapping[str, str]] = ..., user_id: _Optional[str] = ...) -> None: ...
...
class QueryResponse(_message.Message):
    ...
    confidence: float
    model_used: str
    def __init__(self, response: _Optional[str] = ..., sources: _Optional[_Iterable[str]] = ..., confidence: _Optional[float] = ..., model_used: _Optional[str] = ...) -> None: ...
...
class ScreenFrame(_message.Message):
    ...
    width: int
    height: int
    def __init__(self, image_data: _Optional[bytes] = ..., window_title: _Optional[str] = ..., timestamp: _Optional[int] = ..., width: _Optional[int] = ..., height: _Optional[int] = ...) -> None: ...
...
class ContextAnalysis(_message.Message):
    ...
    def __init__(self, detected_context: _Optional[str] = ..., suggestions: _Optional[_Iterable[str]] = ..., active_1c_object: _Optional[str] = ..., ui_elements: _Optional[_Mapping[str, str]] = ...) -> None: ...
...
class CodeSearchRequest(_message.Message):
    ...
    def __init__(self, query: _Optional[str] = ..., language: _Optional[str] = ..., max_results: _Optional[int] = ..., file_filters: _Optional[_Iterable[str]] = ...) -> None: ...
...
class CodeSearchResponse(_message.Message):
    ...
    total_found: int
    def __init__(self, results: _Optional[_Iterable[_Union[CodeResult, _Mapping]]] = ..., total_found: _Optional[int] = ...) -> None: ...

class CodeResult(_message.Message):
    __slots__ = ("file_path", "code_snippet", "line_number", "relevance_score", "object_type")
    ...
    object_type: str
    def __init__(self, file_path: _Optional[str] = ..., code_snippet: _Optional[str] = ..., line_number: _Optional[int] = ..., relevance_score: _Optional[float] = ..., object_type: _Optional[str] = ...) -> None: ...
...
class DependencyRequest(_message.Message):
    ...
    module_name: str
    depth: int
    def __init__(self, module_name: _Optional[str] = ..., depth: _Optional[int] = ...) -> None: ...
...
class Dependency(_message.Message):
    ...
    to_module: str
    dependency_type: str
    def __init__(self, from_module: _Optional[str] = ..., to_module: _Optional[str] = ..., dependency_type: _Optional[str] = ...) -> None: ...
...
class MetadataRequest(_message.Message):
    ...
    object_name: str
    object_type: str
    def __init__(self, object_name: _Optional[str] = ..., object_type: _Optional[str] = ...) -> None: ...
...
class MetadataResponse(_message.Message):
    ...
    def __init__(self, object_name: _Optional[str] = ..., object_type: _Optional[str] = ..., properties: _Optional[_Mapping[str, str]] = ..., methods: _Optional[_Iterable[str]] = ...) -> None: ...
...
class ScenarioRequest(_message.Message):
    ...
    current_context: str
    user_role: str
    def __init__(self, current_context: _Optional[str] = ..., user_role: _Optional[str] = ...) -> None: ...
...
class Scenario(_message.Message):
    ...
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., description: _Optional[str] = ..., relevance: _Optional[float] = ..., required_params: _Optional[_Iterable[str]] = ...) -> None: ...
...
class ExecuteRequest(_message.Message):
    ...
    def __init__(self, scenario_id: _Optional[str] = ..., params: _Optional[_Mapping[str, str]] = ...) -> None: ...

class ExecutionStatus(_message.Message):
    __slots__ = ("stage", "progress", "message", "is_complete", "has_error", "error_message")
    ...
    has_error: bool
    error_message: str
    def __init__(self, stage: _Optional[str] = ..., progress: _Optional[float] = ..., message: _Optional[str] = ..., is_complete: bool = ..., has_error: bool = ..., error_message: _Optional[str] = ...) -> None: ...

...
@router.get("/stats")
async def get_platform_stats(service: AdminDashboardService = Depends(get_admin_service)):
    """Platform statistics."""
    return await service.get_platform_stats()


@router.get("/tenants/{tenant_id}")
async def get_tenant_details(tenant_id: str, service: AdminDashboardService = Depends(get_admin_service)):
    """Tenant details."""

...
class KPIGenerationRequest(BaseModel):
    ...
    feature_id: Optional[str] = Field(default=None, description="Feature ID for graph search")
...
class ProcessModelRequest(BaseModel):
    ...
    requirement_id: Optional[str] = Field(default=None, description="Requirement ID for graph linking")
    format: str = Field(default="mermaid", description="Output format (mermaid, plantuml, json)")
    use_graph: bool = Field(default=True, description="Use Unified Change Graph")
...
class JourneyMapRequest(BaseModel):
    ...
    stages: Optional[List[str]] = Field(default=None, description="List of stages (optional)")
    format: str = Field(default="mermaid", description="Output format (mermaid, plantuml, json)")
    use_graph: bool = Field(default=True, description="Use Unified Change Graph")
...
class SyncRequirementsRequest(BaseModel):
    ...
    issue_type: str = Field(default="Story", description="Issue type (Story, Task, Epic)")
    use_graph: bool = Field(default=True, description="Use Unified Change Graph")
...
class EnablementPlanRequest(BaseModel):
    ...
    include_examples: bool = Field(default=True, description="Include examples from graph")
    use_graph: bool = Field(default=True, description="Use Unified Change Graph")
...
class GuideRequest(BaseModel):
    ...
    format: str = Field(default="markdown", description="Output format (markdown, confluence, html)")
    include_code_examples: bool = Field(default=True, description="Include code examples from graph")
    use_graph: bool = Field(default=True, description="Use Unified Change Graph")
...
class PresentationRequest(BaseModel):
    ...
    audience: str = Field(default="stakeholders", description="Audience (stakeholders, technical, executive)")

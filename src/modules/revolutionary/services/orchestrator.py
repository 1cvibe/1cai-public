...
from src.modules.revolutionary.domain.models import (
    ...
    SelfEvolvingMetrics,
    SelfHealingMetrics,
    DistributedAgentMetrics,
    CodeDNAMetrics,
    PredictiveGenerationMetrics,
)
...
class RevolutionaryOrchestrator:
    ...
    def __init__(self):
        ...
        self.use_self_evolving = os.getenv("USE_SELF_EVOLVING", "false").lower() == "true"
        self.use_self_healing = os.getenv("USE_SELF_HEALING", "false").lower() == "true"
        self.use_distributed_agents = os.getenv("USE_DISTRIBUTED_AGENTS", "false").lower() == "true"
        self.use_code_dna = os.getenv("USE_CODE_DNA", "false").lower() == "true"
        self.use_predictive = os.getenv("USE_PREDICTIVE_GENERATION", "false").lower() == "true"

...
evolution_fitness = Gauge(
    "advanced_evolution_fitness", "Current evolution fitness"
)
...
fixes_applied_total = Counter(
    "advanced_fixes_applied_total", "Total fixes applied"
)
...
dna_evolutions_total = Counter(
    "advanced_dna_evolutions_total", "Total DNA evolutions"
)

dna_mutations_total = Counter(
    "advanced_dna_mutations_total", "Total DNA mutations"
)

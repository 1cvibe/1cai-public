...
council_latency_seconds = Histogram(
    "council_latency_seconds", "Council query latency in seconds", buckets=[1, 5, 10, 15, 20, 30, 45, 60]
)

council_cost_multiplier = Histogram(
    "council_cost_multiplier", "Council cost multiplier (number of models used)", buckets=[2, 3, 4, 5, 6, 7, 8, 10]
)
...
false_positives_total = Counter(
    "security_false_positives_total", "Number of potential false positives in security validation"
)

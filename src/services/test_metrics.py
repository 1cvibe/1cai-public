...
class TestMetricsCollector:
    ...
    def collect_from_junit_report(
        ...
        try:
            ...
            for testsuite in root.findall(".//testsuite"):
                ...
                passed_tests += int(testsuite.get("tests", 0)) - int(testsuite.get("failures", 0)) - int(testsuite.get("errors", 0))
    ...
    def save_metrics(
        ...
        logger.info(
            "Metrics saved",
            extra={"metrics_file": str(metrics_file)}
        )
    ...
    def compare_metrics(
        ...
        comparison = {
            "total_tests": {
                ...
                "change_percent": (
                    ((current.total_tests - previous.total_tests) / previous.total_tests * 100)
            ...
            "execution_time": {
                ...
                "change_percent": (
                    ((current.execution_time - previous.execution_time) / previous.execution_time * 100)

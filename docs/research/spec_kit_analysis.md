...
| **Observability & Monitoring** | RED/USE метрики, логи, трассировки, SLO/Error Budgets, alert runbooks | `github-monitor.yml`, `dora-metrics.yml`, `/metrics` (Prometheus Instrumentator), `docs/observability/SLO.md`, `docs/runbooks/alert_slo_runbook.md`; TODO: интеграция с Prometheus/Grafana | Добавить сбор SLI (Prometheus exporter/Logs), завести alert-канал |
